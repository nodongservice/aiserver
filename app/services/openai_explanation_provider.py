                        ...
                        "text": json.dumps(
                            {
                                ...
                                "output_rules": {
                                    ...
                                    "next_step_summary": ("next_step_candidates가 있으면 섹션 제목을 반복하지 말고 바로 요약 문장 1~2개를 작성한다. 후보가 없으면 빈 문자열을 반환한다."),
                                    "recommended_programs": ("next_step_candidates에 있는 프로그램만 0~2개 고른다. 후보에 없는 프로그램명은 절대 만들지 않는다. title, source_type, record_id 등 식별 필드는 후보 값을 그대로 보존한다. reason은 제목만 반복하지 말고 이 프로그램으로 무엇을 준비하거나 보완할 수 있는지 공고 준비 맥락에서 구체적으로 1문장으로 쓴다."),
                                },
                            },
                            ensure_ascii=False,
                        ),
