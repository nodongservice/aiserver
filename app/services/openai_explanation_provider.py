                ...
                "content": [
                    {
                        ...
                        "text": (
                            ...
                            "README 범위 밖 정보는 확인된 사실처럼 말하지 말고, check_points에 확인할 항목으로 분리하라. "
                            "요약이나 상세 설명 마지막에 역접 접속부사로 시작하는 유보 문장을 붙이지 마라. "
                        ...
                        "text": json.dumps(
                            {
                                ...
                                "output_rules": {
                                    ...
                                    "short_summary": ("추천 요약에 해당하는 2~3문장. 회사명, 직무명, 점수를 자연스럽게 포함한다. 부족한 데이터나 확인 필요 항목은 요약 뒤에 덧붙이지 말고 check_points에만 작성한다."),
