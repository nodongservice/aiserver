...
TRANSPORT_SUPPORT_CENTER: Final[str] = "TRANSPORT_SUPPORT_CENTER"
SEOUL_WHEELCHAIR_RAMP_STATUS: Final[str] = "SEOUL_WHEELCHAIR_RAMP_STATUS"
SEOUL_LOW_FLOOR_BUS_ROUTE_RETENTION: Final[str] = "SEOUL_LOW_FLOOR_BUS_ROUTE_RETENTION"
...
PUBLIC_DATA_SOURCE_NAMES: Final[dict[str, str]] = {
    ...
    SEOUL_WHEELCHAIR_RAMP_STATUS: "서울교통공사 휠체어경사로 설치 현황",
