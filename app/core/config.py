...
class Settings:
    ...
    profile_draft_ocr_subprocess_timeout_seconds: float = float(os.getenv("PROFILE_DRAFT_OCR_SUBPROCESS_TIMEOUT_SECONDS", "120"))
    ...
    profile_draft_embedded_max_replacement_ratio: float = float(os.getenv("PROFILE_DRAFT_EMBEDDED_MAX_REPLACEMENT_RATIO", "0.08"))
